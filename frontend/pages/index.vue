    ...
    <div class="container mx-auto md:w-9/12 lg:w-7/12 px-4 md:px-0">
      <div class="pt-10 lg:pt-14">
        <div class="flex items-center justify-center flex-col leading-10">
          ...
          <h4
            style="color: #7694a0"
            class="text-sm md:text-base text-center lg:w-4/5 font-[500] text-gray-700 pt-4"
          >
      ...
      <div class="pt-4 sm:pt-8 md:pt-12 lg:pt-16">
        <div class="flex flex-col xl:flex-row items-center justify-center">
          ...
          <div class="flex flex-col xl:flex-row xl:w-3/4 xl:justify-end">
            ...
            <div
              class="pt-4 md:pt-2 xl:pt-0 w-full xl:w-40 xl:ml-4 flex items-center justify-center"
            >
              <button
      ...
      <div class="py-3">
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-y-4 sm:gap-y-0">
          <div
            ...
            :key="index"
            class="bg-white py-6 px-7 border h-44 lg:h-32 xl:h-24"
          >
            <div>
              <div class="pt-4 lg:pt-0 flex flex-col">
                ...
                <div class="flex flex-col lg:flex-row pt-2">
                  <div
                    class="pt-1 lg:pt-0 flex flex-row justify-center lg:justify-start items-center"
                  >
                  ...
                  <div
                    class="pt-3 lg:pt-0 lg:ml-2 flex flex-row justify-center lg:justify-start items-center"
                  >
                  ...
                  <div
                    class="pt-3 lg:pt-0 lg:ml-2 flex flex-row items-center justify-center lg:justify-start"
                  >
