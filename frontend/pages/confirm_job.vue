                    ...
                    <div class="flex flex-col xl:flex-row">
                        ...
                        <div class="xl:w-7/12 pt-4 xl:pt-0 xl:ml-8 flex flex-col">
                            ...
                            <div class="pt-1 flex flex-wrap">
                                <p v-for="(item, index) in mydetails" :key="index" class="text-xs m-2 text-gray-500">
                            ...
                            <div class="w-full">
                                <div class="my-4">
                                    ...
                                    <p class="text-sm font-extralight pt-4 text-gray-600">
                                        ...
                                        That’s why we built Mercari—to connect people who want to buy and sell things of
                                        emotional value through their mobile phones. Mercari has grown to become a leading
                                        community-powered marketplace that brings together millions of people every day.
                                    ...
                                    <p class="text-sm font-extralight pt-4 text-gray-600">
                                        ...
                                        <span class="font-bold text-black">Apply at: </span>devjobs@ejara.com
                                    </p>
                                    <!-- <p class="text-sm font-extralight pt-4 text-gray-600">
                                    ...
                                    <p class="text-sm font-extralight pt-4 text-gray-600">
                                        <span class="font-bold text-black">Salary range: </span>Min(xxx
                                        FCFA), Max(xxx FCFA)
                                    </p>
                                </div>
                                <div class="my-8">
                                    <NuxtLink to="#"
                                        ...
                                        <p class="flex items-center justify-center">
                                            Learn more about the job offer<span><img class="ml-1 w-2 h-auto" alt="pic"
                                                    :src="arrow" /></span>
                                        </p>
                                    </NuxtLink>
                                </div>
